...
async def get_available_configurations(http_request: Request):
    """
...
@app.post("/instances")
async def list_instances_route(req: InstanceRequest, http_request: Request):
    """
    ...
    try:
        data = instance_service.list_instances(req.config_names)
...
@app.post("/schemas")
async def list_schemas_route(req: SchemaRequest, http_request: Request):
    """
    ...
    try:
        data = schema_service.list_schemas(req.config_name, req.instance_name)
...
@app.post("/tables")
async def list_tables_route(req: TableRequest, http_request: Request):
    """
...
@app.post("/describe")
async def describe_table_route(req: DescribeTableRequest, http_request: Request):
    """
